...
@retry(tries=3)
def get_domain_ips(domain, record_type="A"):
    """
...
def main():
    ...
    tmdb_host_ipv4_path = os.path.join(os.path.dirname(__file__), "Tmdb_host_ipv4")
    tmdb_host_ipv6_path = os.path.join(os.path.dirname(__file__), "Tmdb_host_ipv6")
